            ...
            return (
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ? "bg-gradient-to-r from-emerald-500/15 to-teal-500/5 text-emerald-400 border border-emerald-500/30"
              ...
              >
                ...
                {!collapsed &&
                  ...
                  newCount > 0 && (
                    <span className="ml-auto px-1.5 py-0.5 bg-emerald-500 text-black text-xs font-bold rounded-full">
                      {newCount}
                    </span>
                  )}
              </Link>
        ...
        <div className="p-3 border-t border-white/8">
          ...
          {session?.user && !collapsed && (
            <div className="flex items-center gap-3 px-3 py-2 mb-2 rounded-xl bg-white/5 border border-white/8">
              <div className="w-9 h-9 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center text-black font-bold text-sm">
          ...
          <Link
            href="/"
            className={cn(
              "flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-gray-400 hover:text-emerald-400 hover:bg-emerald-500/10 w-full transition-colors mt-1",
              collapsed && "justify-center"
            )}
          >
